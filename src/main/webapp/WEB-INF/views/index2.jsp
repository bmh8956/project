...
<body class="js">
										...
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
												<li class="active"><a href="#">Home<i class="ti-angle-down"></i></a>
													<ul class="dropdown">
														<li><a href="/index">Home Ecommerce V1</a></li>
														<li><a href="/index2">Home Ecommerce V2</a></li>
														<li><a href="/index3">Home Ecommerce V3</a></li>
														<li><a href="/index4">Home Ecommerce V4</a></li>
													</ul>
												</li>
	...
	<section class="hero-area2">
		<div class="home-slider">
			<!-- Start Single Slider -->
<%--			<div class="single-slider overlay" style="background-image:url('images/test/new_01.jpg');">--%>
<%--				<div class="container">--%>
<%--					<div class="row">--%>
<%--						<div class="col-12">--%>
<%--							<div class="content">--%>
						...
						<div class="content">
							<div class="heading-block">
								...
								<div class="coming-time">
									<div class="clearfix" data-countdown="2024/01/16"></div>
								</div>
							</div>
						</div>	
					</div>	
